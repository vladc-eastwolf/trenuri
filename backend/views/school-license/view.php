...
$this->title = 'School License Check';
$this->params['breadcrumbs'][] = ['label' => 'School Licenses', 'url' => ['index']];
...
<div class="school-license-view">
    ...
    <div class="student-license-photos" style="padding-top: 10px;padding-bottom: 10px;">
        <div class="row" style="padding-bottom: 10px">
            <div class="col-lg-6"><?= Html::img(Url::to(['/image/school-open', 'id' => $model->id]), ['style' => 'width:500px; height:200px']) ?></div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-2">
